...
Two recipe behaviours are not obvious from a single file and matter when running a recipe unattended:
...
Two upgrade paths are not what they appear to be; check before "fixing" a version:
